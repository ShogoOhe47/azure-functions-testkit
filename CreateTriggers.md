...
func new --name BlobOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name BlobTrigger1  --template "Azure Blob Storage trigger"
func new --name CosmosDBOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name CosmosDBTrigger1  --template "Azure Cosmos DB trigger"
func new --name EventGridOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name EventGridTrigger1  --template "Azure Event Grid trigger"
func new --name EventHubOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name EventHubTrigger1  --template "Azure Event Hub trigger"
func new --name KafkaOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name KafkaTrigger1  --template "Kafka trigger"
func new --name QueueStorageOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name QueueStorageTrigger1  --template "Azure Queue Storage trigger"
func new --name RabbitMQOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name RabbitMQTrigger1  --template "RabbitMQ trigger"
func new --name ServiceBusQueueOutput1  --template "HTTP trigger" --authlevel "anonymous"
func new --name ServiceBusQueueTrigger1  --template "Azure Service Bus Queue trigger"
func new --name ServiceBusTopicOutput1  --template "HTTP trigger" --authlevel "anonymous"
